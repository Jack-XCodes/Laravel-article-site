    ...
    <div class="max-w-md w-full">
        ...
        <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-2xl border border-gray-200 dark:border-gray-700 overflow-hidden">
            ...
            <div class="bg-gradient-to-r from-blue-600 to-yellow-500 px-8 py-8 text-center">
                ...
                <h2 class="text-2xl font-bold text-white font-['Playfair_Display']">Join Our Community!</h2>
                <p class="text-blue-100 mt-2">Create your account to start sharing</p>
            </div>
                ...
                <form method="POST" action="{{ route('register') }}" class="space-y-6">
                    ...
                    <div class="flex items-start">
                        ...
                        <label for="terms" class="ml-2 text-sm text-gray-600 dark:text-gray-400">
                            I agree to the 
                            <a href="#" class="text-blue-600 dark:text-yellow-400 hover:text-blue-800 dark:hover:text-yellow-300 font-medium">Terms of Service</a> 
                            and 
                            <a href="#" class="text-blue-600 dark:text-yellow-400 hover:text-blue-800 dark:hover:text-yellow-300 font-medium">Privacy Policy</a>
                        </label>
                    </div>
